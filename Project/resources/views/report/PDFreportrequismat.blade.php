                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-right">รหัสวัตถุดิบ</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($requismatpdf as $requismatpdff )
                        <tr>
                            <td class="no">{{$requismatpdff->Requismat_Date}}</td>
                            <td class="qty">{{App\Materials::find($requismatpdff->Material_Id)->Material_Name}}</td>
                            <td class="unit">{{$requismatpdff->Requismat_Amount}}</td>
                            <td class="qty">{{App\Materials::find($requismatpdff->Material_Id)->idmat}}</td>
                        </tr>
                        @endforeach
                    </tbody>
